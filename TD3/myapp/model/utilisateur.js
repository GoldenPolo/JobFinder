...
module.exports = {
    ...
    create: function (id, email, nom, prenom, pwd, type, telephone, callback) {
        db.query("insert into Utilisateur(id, email, nom, prenom, motDePasse, type, telephone, dateCreation, estActif) values(?, ?, ?, ?, ?, ?, ?, ?, ?)", [id, email, nom, prenom, pwd, type, telephone, new Date, 1], function (err, results) {
            if (err) throw err;
            callback(results);
        });
    },
